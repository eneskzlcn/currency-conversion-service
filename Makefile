...
generate-mocks:
	...
	mockgen -destination=internal/mocks/conversion/mock_conversion_repository.go -package mocks github.com/eneskzlcn/currency-conversion-service/internal/conversion ConversionRepository
